...
Одностраничный лендинг для клуба загородного отдыха. Главная фишка проекта - *тематические анимации на GSAP:*
* Плавный скролл с ScrollSmoother;
* Параллакс через data-speed - изменение скорости пролистывания разных элементов;
* Анимации методом gsap.fromTo, где указывается начальное положение и конечное с атрибутами перехода.
...
природы, что способствует погружению в проект, а значит вероятнее заинтересует.
